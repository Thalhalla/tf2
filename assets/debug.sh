...
/bin/bash /home/steam/serverfiles/tf2/srcds_run -console -game tf -nohltv +sv_pure 1 +randommap +maxplayers 24 +sv_setsteamaccount $STEAM_GSLT -port $PORT -exec $TF2_EXEC -debug
